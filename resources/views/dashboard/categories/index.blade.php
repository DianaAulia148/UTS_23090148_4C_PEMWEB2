<x-layouts.app :title="('Categories')">
    ...
    <div class="w-full overflow-x-auto">
        <table class="w-full min-w-max table-auto leading-normal">
            <thead>
                <tr>
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <flux:dropdown>
                                ...
                                <flux:menu>
                                    ...
                                    <form id="delete-form-{{ $category->id }}" action="{{ route('dashboard.categories.destroy', $category->id) }}" method="POST" class="hidden">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </flux:menu>
